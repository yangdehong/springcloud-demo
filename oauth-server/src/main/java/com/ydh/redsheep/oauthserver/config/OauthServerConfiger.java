package com.ydh.redsheep.oauthserver.config;
...
public class OauthServerConfiger extends AuthorizationServerConfigurerAdapter {
    ...
    private String sign_key = "ydh999"; // jwt签名密钥
...
//                .withClient("client_ydh")  // 添加一个client配置,指定其client_id
...
//        return new InMemoryTokenStore();
    ...
    public AuthorizationServerTokenServices authorizationServerTokenServices() {
        ...
        // 设置令牌有效时间（一般设置为2个小时）
        defaultTokenServices.setAccessTokenValiditySeconds(3600); // access_token就是我们请求资源需要携带的令牌
        // 设置刷新令牌的有效时间
        defaultTokenServices.setRefreshTokenValiditySeconds(24 * 3600); // 3天
